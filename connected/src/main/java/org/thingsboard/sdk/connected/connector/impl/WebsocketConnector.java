...
public class WebsocketConnector implements Connector {
    ...
    @Override
    public void connect(ConnectOptions connectOptions, ConnectStatusCallback connectStatusCallback) throws Exception {
        this.messageStatusCallback = messageStatusCallback;
        connectServer(connectOptions);
    }
    ...
    private void connectServer(ConnectOptions connectOptions) throws Exception {
        synchronized (this) {
            if (wc == null) {
